...
const HomeScreen = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={{...globalStyles.globalTextStyles,fontSize: hp('3'), marginLeft: wp('5')}}>
        Enjoy your life with us!
      </Text>
      <View>
        <SearchBarComponents/>
      </View>
      <Text style={{...globalStyles.globalTextStyles,fontSize: hp('2.8'), marginLeft: wp('5')}}>
        Top Destinations
      </Text>
      <FrontPackageCom />
      <View>
      ...
      <Text style={{...globalStyles.globalTextStyles, fontSize: hp('2.8'),marginLeft: wp('5')}}>
        ...
        <TouchableOpacity style={styles.hotTextTouc}>
          <Text style={{ color:color.white,fontWeight:'bold' ,fontSize:hp('1.7') }}>Hot</Text>
        </TouchableOpacity>
      </View>
      <FlatList
              data={topCities}
                ...
                return (
                  <TouchableOpacity
                    ...
                    borderRadius={10}
                      ...
                      source={{ uri:"https://cdn.britannica.com/62/153462-050-3D4F41AF/Grand-Canal-Venice.jpg" }}
                    >
